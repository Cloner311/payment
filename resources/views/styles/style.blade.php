@if (file_exists(public_path('assets/vendor/rahabitpayment/fonts/IRANSansWeb_Bold.woff2')))
	<style type="text/css">
	@font-face {
		font-family: "IranSans";
		font-style: normal;
		font-weight: bold;
		src: url("assets/vendor/rahabitpayment/fonts/IRANSansWeb_Bold.woff2") format("woff2");
	}
	...
	@font-face {
		...
		font-weight: 300;
		font-style: normal;
		src: url("assets/vendor/rahabitpayment/fonts/IRANSansWeb_Light.woff2") format("woff2");
	}
	</style>
@else
	<style type="text/css">
